...
export function LibraryPanel({ bridge, showSetFolder = false, showFullRefresh = false }) {
  ...
  return (
    <div className="flex flex-col h-full gap-2 overflow-hidden">
      {/* Header Controls */}
      <div className="flex flex-col gap-2 pb-2 border-b border-gray-200 dark:border-gray-700 shrink-0">
      ...
      {!searchTerm && !scanProgress && (
        <div className="flex flex-col gap-1.5 p-2 bg-gray-100 dark:bg-gray-800/50 rounded-md shrink-0">
      ...
      {loading ? (
        ...
        <>
          ...
          {totalPages > 1 && !scanProgress && (
            <div className="flex items-center justify-center gap-3 p-2 bg-gray-100 dark:bg-gray-800/50 rounded-md text-sm shrink-0">
              <button
